      ...
      <div className='flex pt-2 pb-2 pl-6 pr-6 w-full justify-between items-center'>
        <div className='flex gap-4 items-center'>
          <Link href='/' className='flex gap-4 items-center'>
            <img className="w-8.5 h-8.5 rounded-4xl" src="img/avatar/Im-just-watching.jpg" alt="profile"/>
          ...
          <div className='flex'>
            ...
            <Link href='/c' className='pl-3 pr-3 pt-1 pb-1 rounded-4xl hover:bg-blend-overlay hover:bg-[#35313f] hover:blend-multiply transition' >
              <p>만든 거</p>
            </Link>
            <Link href='/font-size' className='pl-3 pr-3 pt-1 pb-1 rounded-4xl hover:bg-blend-overlay hover:bg-[#35313f] hover:blend-multiply transition' >
              <p>폰트 사이즈</p>
            </Link>
          </div>
        </div>
